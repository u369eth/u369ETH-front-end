      ...
      <Modal show={show} onHide={handleClose} centered>
        <motion.div
          ...
          <Modal.Header
            ...
            <Modal.Title style={{ fontSize: "22px" }}>Master Key</Modal.Title>
            <CloseButton
              variant="white"
              onClick={() => {
                handleClose();
              ...
              <Form.Group className="mb-3" controlId="formBasicEmail">
                ...
                <Form.Text className="lighttext fw-bold list mb-0">
                  ...
                  <div className="mt-2">
                    ...
                    <p>
                      Before setting your Sign Key (password/PIN) below, ensure
                      to copy and save the Master Key in a safe place (ideally
                      offline).
                    </p>
                    <p>
                      Your protected tokens can only be sent after you input
                      your Sign Key. If you lose your Sign Key and don't have
                      the Master Key, you won’t be able to interact with this
                      smart contract.
                    </p>
                    To set Sign Key:
                    <ul>
                      <li>Copy and save the Master Key.</li>
                ...
                <div className="d-flex mt-0">
                  ...
                  <label htmlFor="" className="ms-3">
                    I understand that u369.eth cannot recover the Sign Key for
                    me.
                  </label>
                </div>
              </Form.Group>
          ...
          {isEnable && isEnable2 && (
            <Modal.Footer style={{ border: "none", paddingTop: 0 }}>
              <button
                className="btn btn-primary bg-transparent border border-primary enableBtn"
